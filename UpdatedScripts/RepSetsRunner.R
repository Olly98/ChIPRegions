...
Model=tryCatch({hmm((PUS$OverlapPattern),K=k,itmax=1000)} , error = function(e) { skip_to_next <<- TRUE})
...
saveRDS(OptimalModelReps,file="OptimalHMMsRepSets.rds")
saveRDS(OptimalStateReps,file="OptimalStateRepSets.rds")
